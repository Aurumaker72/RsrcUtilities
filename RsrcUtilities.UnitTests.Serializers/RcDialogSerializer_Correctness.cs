...
namespace RsrcUtilities.UnitTests.Serializers;
...
public class RcDialogSerializer_Correctness
{
    ...
    public void Test_Serialization()
    {
        ...
        int serializedWidth = int.Parse(bareDialogDefinition[4]);
        int serializedHeight = int.Parse(bareDialogDefinition[5]);
